...
Use this prompt when executing development work based on an implementation plan file.
...
1. The path to the implementation plan file
2. Any additional context or constraints
3. Confirmation to begin execution

The AI will then systematically work through the plan, tracking progress and maintaining high code quality throughout.
